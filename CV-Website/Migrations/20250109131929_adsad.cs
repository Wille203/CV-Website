...
namespace CV_Website.Migrations
{
    ...
    public partial class adsad : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "UserId", "Address", "Email", "Name", "Password", "PhoneNumber", "Private", "img" },
                values: new object[,]
                {
                    { 1, "Drottninggatan 10", "alice@example.com", "Alice", "password123", "+46701234567", false, null },
                    { 2, "Storgatan 5", "bob@example.com", "Bob", "securepassword", "0701234567", true, null },
                    { 3, "Kungsgatan 18", "charlie@example.com", "Charlie", "charlie123", "+46761234567", false, null },
                    { 4, "Östra Långgatan 22", "dave@example.com", "Dave", "dave456", "0761234567", false, null },
                    { 5, "Västra Vallgatan 4", "eve@example.com", "Eve", "eve789", "+46731234567", true, null },
                    { 6, "Kyrkogatan 8", "frank@example.com", "Frank", "frank101", "0731234567", false, null }
                });
